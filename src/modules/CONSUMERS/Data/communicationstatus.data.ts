...
export const communicationStatusMaxResponseTimeMs = MASTER_DATA_MAX_RESPONSE_TIME_MS;
...
export function resolveCommunicationStatusRef(
  ...
  switch (scenario) {
    ...
    case "invalid_date":
      return resolveLiveIvrs(process.env.CONSUMER_COMM_STATUS_IVRS, communicationStatusDefaultIvrs);
...
export function resolveCommunicationStatusQuery(
  ...
  switch (scenario) {
    ...
    case "empty_consumer_ref":
      return {
        date: process.env.CONSUMER_COMM_STATUS_DATE?.trim() || communicationStatusSampleDate,
      };
    case "status_dd_mm_yyyy":
...
export const communicationStatusTestCases: CommunicationStatusTestCase[] = [
  {
    testName: "Meter communication — status for a chosen date",
    scenario: "status_with_date",
    tags: ["@smoke", "@consumer", "@communication-status"],
    nonEmptyExpected: true,
  },
  {
    testName: "Meter communication — status for today when no date is given",
    scenario: "status_default_today",
    tags: ["@consumer", "@communication-status", "@edge"],
    nonEmptyExpected: false,
  },
  {
    testName: "Meter communication — wrong date format is rejected",
  ...
  {
    testName: "Meter communication — status opens using the meter",
    scenario: "status_by_meter",
    tags: ["@consumer", "@communication-status", "@edge"],
    nonEmptyExpected: false,
  },
  {
    testName: "Meter communication — sample: no readings for the day",
  ...
  {
    testName: "Meter communication — sample: readings received with delay",
  ...
  {
    testName: "Meter communication — invalid date is rejected",
  ...
  {
    testName: "Meter communication — unknown consumer is not found",
  ...
  {
    testName: "Meter communication — unknown meter shows empty or not found",
    scenario: "meter_not_found",
    tags: ["@consumer", "@communication-status", "@negative"],
    nonEmptyExpected: false,
  },
  {
    testName: "Meter communication — blank consumer number is rejected",
