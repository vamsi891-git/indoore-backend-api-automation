...
import {ActivationErrorResponse,ConsumerActivationResponse,ConsumerActivationStatus,} from "../Mapper/activation.mapper";
...
export class ActivationApi extends TimedApiClient {
    ...
    updateActivation(consumerId: string,payload: ActivationRequestBody,): Promise<ActivationApiResult> {
    ...
    patchActivationRaw(consumerId: string,data: unknown,): Promise<ActivationErrorApiResult> {
