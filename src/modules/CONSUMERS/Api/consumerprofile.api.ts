...
export class ConsumerProfileApi extends TimedApiClient {getConsumerProfile(consumerRef: string,query: ConsumerProfileQuery = {},): Promise<ConsumerProfileApiResult> {
