...
export class CommunicationStatusApi extends TimedApiClient {getCommunicationStatus(consumerRef: string,query: CommunicationStatusQuery = {},): Promise<CommunicationStatusApiResult> {
