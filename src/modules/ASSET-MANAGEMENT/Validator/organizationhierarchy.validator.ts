...
export class OrganisationHierarchyValidator {
  ...
  validateHierarchyFields(nodes: OrganisationNode[]) {
    ...
    walk(nodes);
    if (emptyOfficeCodeCount > 0) {
      console.log(`Empty officeCode nodes (allowed): ${emptyOfficeCodeCount}`);
    }
  }
