...
test.describe("Module Permission CRUD Flow", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      // CREATE MODULE
      // =====================================
      const createModulePayload = ModulePermissionData.buildUniqueModulePayload();
      ...
      validation.execute("Create Module Status Code", () =>
        assert.validateStatusCode(
          ...
          201,
          createModuleResponse.responseBody,
        ),
      );
      ...
      // UPDATE MODULE
      // =====================================
      const updateModuleResponse = await moduleApi.updateModule(
        ModulePermissionData.moduleId,
        ModulePermissionData.updateModulePayload,
      );
      ...
      // CREATE PERMISSION
      // =====================================
      const createPermissionResponse = await moduleApi.createPermission(
        ModulePermissionData.moduleId,
        ModulePermissionData.createPermissionPayload,
      );
      ...
      // UPDATE PERMISSION
      // =====================================
      const updatePermissionResponse = await moduleApi.updatePermission(
        ModulePermissionData.permissionId,
        ModulePermissionData.updatePermissionPayload,
      );
      ...
      const updatedPermission = ModulePermissionMapper.mapPermission(
        updatePermissionResponse.responseBody,
      );
      validation.execute("Validate Updated Permission", () =>
        validator.validateUpdatedPermission(
          updatedPermission,
          ModulePermissionData.updatePermissionPayload,
        ),
      );
      ...
      const createdModuleAfterUpdate = verifyModules.find(
        (module) => module.id === ModulePermissionData.moduleId,
      );
      ...
      const updatedPermissionExists = createdModuleAfterUpdate?.permissions.find(
        (permission) => permission.id === ModulePermissionData.permissionId,
      );
      ...
      validation.execute("Validate Updated Permission Name", () => {
        expect(updatedPermissionExists?.name).toBe(
          ModulePermissionData.updatePermissionPayload.name,
        );
      });
      validation.execute("Validate Updated Permission Description", () => {
        expect(updatedPermissionExists?.description).toBe(
          ModulePermissionData.updatePermissionPayload.description,
        );
      });
      // =====================================
      // STEP 7
      // DELETE PERMISSION
      // =====================================
      const deletePermissionResponse = await moduleApi.deletePermission(
        ModulePermissionData.permissionId,
      );
      ...
      const modulesAfterPermissionDelete = ModulePermissionMapper.mapModules(
        verifyPermissionDeletedResponse.responseBody,
      );
      const moduleAfterPermissionDelete = modulesAfterPermissionDelete.find(
        (module) => module.id === ModulePermissionData.moduleId,
      );
      const deletedPermission = moduleAfterPermissionDelete?.permissions.find(
        (permission) => permission.id === ModulePermissionData.permissionId,
      );
      ...
      const finalModules = ModulePermissionMapper.mapModules(
        verifyModuleDeletedResponse.responseBody,
      );
      const deletedModule = finalModules.find(
        (module) => module.id === ModulePermissionData.moduleId,
      );
