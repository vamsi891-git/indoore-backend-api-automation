...
test.describe("User Profile Image — Negative", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const { rawResponse, responseBody, responseTime } = await profileApi.getProfileImageUploadUrl(
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const validator = new ProfileImageValidator();
      const profileApi = new ProfileImageApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await profileApi.saveProfileImage(
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const profileApi = new ProfileImageApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await profileApi.saveProfileImage(
        ProfileImageData.emptySavePayload,
      );
