...
test.describe("User Profile Image Flow", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const uploadData = ProfileImageMapper.mapUploadUrl(uploadResponse.responseBody);
      ...
      const saved = ProfileImageMapper.mapUserMutation(saveResponse.responseBody);
      ...
      const removed = ProfileImageMapper.mapUserMutation(deleteResponse.responseBody);
      ...
      validation.printSummary(
        ...
        uploadResponse.responseTime + saveResponse.responseTime + deleteResponse.responseTime,
      );
    },
  );
});
