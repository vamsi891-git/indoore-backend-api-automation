...
test.describe("User Admin — List", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const response = await userApi.getUsers(UserManagementData.page, UserManagementData.limit);
      ...
      validation.execute("Validate Pagination", () =>
        validator.validatePagination(usersData.pagination, usersData.users.length),
      );
      validation.execute("Validate Users Exist", () => validator.validateUsers(usersData.users));
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      validation.execute("Validate User Id", () => validator.validateUserById(user, targetUser.id));
      ...
      validation.execute("Validate Session Rules", () => validator.validateSessionRules([user]));
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      validation.execute("Validate Devices", () => validator.validateDevices(mapped.devices));
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const response = await userApi.getAuditLogs(UserManagementData.auditLogQuery);
      ...
      validation.execute("Validate Audit Logs Pagination", () =>
        validator.validateAuditLogsPagination(mapped.pagination, mapped.logs.length),
      );
