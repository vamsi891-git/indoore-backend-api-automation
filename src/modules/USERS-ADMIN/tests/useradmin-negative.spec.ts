...
test.describe("User Admin — Negative", () => {
  ...
  test(
    "GET /users/:id — unknown user returns 404",
    ...
    async ({ authenticatedApi }) => {
      ...
      const { rawResponse, responseBody, responseTime } = await userApi.getUserById(
  ...
  test(
    "PATCH /users/:id — unknown user returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      const validator = new UserManagementValidator();
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.updateUser(
        UserManagementData.unknownUserId,
        { firstName: "Missing" },
      );
      validation.execute("Status (not found)", () =>
  ...
  test(
    "PATCH /users/:id — empty body returns 400",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const users = UserManagementMapper.mapUsers(list.responseBody).users;
      const target = users.find((user) => !isAutomationAccount(user)) ?? users[0];
      const { rawResponse, responseBody, responseTime } = await userApi.updateUserStatus(
        target.id,
  ...
  test(
    "PATCH /users/:id/status — unknown user returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
  ...
  test(
    "GET /users/:id/devices — unknown user returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      const validator = new UserManagementValidator();
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.getUserDevices(
        UserManagementData.unknownUserId,
      );
      validation.execute("Status (not found)", () =>
        assert.validateStatusCode(rawResponse, 404, responseBody),
  ...
  test(
    "DELETE /users/:id/devices/:deviceId — unknown device returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      const validator = new UserManagementValidator();
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.deleteDevice(
  ...
  test(
    "DELETE /users/:id/devices/:deviceId — unknown user returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
  ...
  test(
    "POST /users/:id/force-logout — unknown user returns 404",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      const validator = new UserManagementValidator();
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.forceLogout(
        UserManagementData.unknownUserId,
      );
      validation.execute("Status (not found)", () =>
        assert.validateStatusCode(rawResponse, 404, responseBody),
  ...
  test(
    "GET /users/audit-logs — invalid page returns 400",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      const validator = new UserManagementValidator();
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.getAuditLogs(
  ...
  test(
    "GET /users/audit-logs — invalid sort returns 400",
    { tag: ["@negative", "@users-admin"] },
    async ({ authenticatedApi }) => {
      const assert = new ApiValidationHelper();
      const validation = new ApiValidationHelper();
      ...
      const userApi = new UserManagementApi(authenticatedApi);
      const { rawResponse, responseBody, responseTime } = await userApi.getAuditLogs(
        UserManagementData.invalidAuditLogSortQuery,
      );
