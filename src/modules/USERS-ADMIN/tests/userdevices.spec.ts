    ...
    test("Validate User Devices",
        ...
        async ({ authenticatedApi }) => {
            ...
            if (mapped.devices.length === 0) {
                ...
                await PerformanceTracker.track(devicesResponse.rawResponse,"Get Devices",devicesResponse.rawResponse.url(),devicesResponse.responseTime,);
                return;
            }
            ...
            validation.execute("Verify Device Removed", () => {
                expect(verifyMapped.devices.find(
            ...
            validation.printSummary("User Devices Module",devicesResponse.responseTime +
                    deleteResponse.responseTime +
                    verifyResponse.responseTime,
            );
            await PerformanceTracker.track(devicesResponse.rawResponse,"Get Devices",
