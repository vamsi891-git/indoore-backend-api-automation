...
import { AlarmsEventsPriorityDrillMapper } from "../Mappper/alarms-events-priority-drill.mapper";
    ...
    test(testCase.testName, { tag: testCase.tags }, async ({ authenticatedApi }) => {
      ...
      validate.execute("Response Time", () =>
        assert.validateResponseTime(
          responseTime,
          alarmsEventsPriorityDrillData.maxResponseTime,
        ),
      );
