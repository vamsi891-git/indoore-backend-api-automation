...
import { AlarmsEventsCategoryDrillMapper } from "../Mappper/alarms-events-category-drill.mapper";
    ...
    test(testCase.testName, { tag: testCase.tags }, async ({ authenticatedApi }) => {
      ...
      validate.execute("Response Time", () =>
        assert.validateResponseTime(
          responseTime,
          alarmsEventsCategoryDrillData.maxResponseTime,
        ),
      );
