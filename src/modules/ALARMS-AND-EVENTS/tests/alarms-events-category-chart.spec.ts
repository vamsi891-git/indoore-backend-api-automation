...
import { AlarmsEventsCategoryChartMapper } from "../Mappper/alarms-events-category-chart.mapper";
    ...
    test(testCase.testName, { tag: testCase.tags }, async ({ authenticatedApi }) => {
      ...
      validate.execute("Response Time", () =>
        assert.validateResponseTime(
          responseTime,
          alarmsEventsCategoryChartData.maxResponseTime,
        ),
      );
      ...
      validate.execute("Periods and consumer categories", () =>
