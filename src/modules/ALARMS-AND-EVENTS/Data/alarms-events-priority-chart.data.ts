...
export const EXPECTED_PRIORITY_CHART_DATASET_COLUMNS = [
  "label",
  "data",
  "meterCount",
] as const;

export const EXPECTED_PRIORITY_CHART_SERIES = [
  "1 PH",
  "3PH 4CT",
  "3PH WC",
  "HT",
...
function happyCases(): AlarmsEventsPriorityChartTestCase[] {
  return EXPECTED_PRIORITY_WISE_ROWS.filter((row) => row.priorityId !== 0).map(
    (row) => ({
...
export const alarmsEventsPriorityChartTestCases: AlarmsEventsPriorityChartTestCase[] =
  [
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - extra unused query is ignored",
      params: {
        priority: "Priority 1",
        date: alarmsEventsPriorityChartData.date,
        foo: "1",
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - missing priority is rejected",
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - missing date is rejected",
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - blank priority is rejected",
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - unknown priority is rejected",
      params: {
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - Priority 0 is rejected",
      params: {
        priority: "Priority 0",
        date: alarmsEventsPriorityChartData.date,
      },
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - invalid date is rejected",
    ...
    {
      testName:
        "GET /alarms-events/priority-wise/chart - a future date returns empty totals",
