...
import { AlarmsEventsCategoryDrillResponse } from "../Mapper/alarms-events-category-drill.mapper";
...
export class AlarmsEventsCategoryDrillApi extends TimedApiClient {
  getDrillDown(
    ...
    return this.getJson<AlarmsEventsCategoryDrillResponse>(alarmsEventsCategoryDrillData.path, {
      params,
    });
  }
}
