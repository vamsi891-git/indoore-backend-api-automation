...
import { AlarmsEventsCategoryChartResponse } from "../Mapper/alarms-events-category-chart.mapper";
...
export class AlarmsEventsCategoryChartApi extends TimedApiClient {
  getChart(
    ...
    return this.getJson<AlarmsEventsCategoryChartResponse>(alarmsEventsCategoryChartData.path, {
      params,
    });
  }
}
