...
import { AlarmsEventsPhaseDrillResponse } from "../Mapper/alarms-events-phase-drill.mapper";

export class AlarmsEventsPhaseDrillApi extends TimedApiClient {
  getDrillDown(
    params: Record<string, string | number>,
  ): Promise<ApiCallResult<AlarmsEventsPhaseDrillResponse>> {
    return this.getJson<AlarmsEventsPhaseDrillResponse>(alarmsEventsPhaseDrillData.path, {
      params,
    });
  }
}
