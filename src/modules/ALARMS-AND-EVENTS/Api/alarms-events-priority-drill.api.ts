...
import { AlarmsEventsPriorityDrillResponse } from "../Mapper/alarms-events-priority-drill.mapper";
...
export class AlarmsEventsPriorityDrillApi extends TimedApiClient {
  getDrillDown(
    ...
    return this.getJson<AlarmsEventsPriorityDrillResponse>(alarmsEventsPriorityDrillData.path, {
      params,
    });
  }
}
