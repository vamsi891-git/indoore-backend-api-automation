...
/**
 * Read first-row headers from an ATR report .xlsx export.
 * ExcelJS row.values is 1-indexed (index 0 unused).
 */
export async function readAtrReportExportHeaders(
...
export function normalizeAtrReportExportHeaders(headers: string[]): string[] {
