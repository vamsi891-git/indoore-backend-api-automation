...
export const aberrationsMaxResponseTimeMs = REVENUE_PROTECTION_MAX_RESPONSE_TIME_MS;
...
export const aberrationsTestCases: AberrationsTestCase[] = [
  {
    testName: "Validate GET /indore/revenue-protection/aberrations — default page (FEB 2025)",
