...
import { eventPriorityPath, eventPriorityTestCases } from "../Data/eventpriority3.data";
import { MisDashboardEdgesValidator } from "../Validator/mis-dashboard.edges.validator";
import { ApiValidationHelper } from "../../../core/helpers/api-validation.helper";

test.describe("Urgency level 3 events", () => {
  ...
  test(
    "Urgency level 3 events — consumer and DTR stay within all meters",
