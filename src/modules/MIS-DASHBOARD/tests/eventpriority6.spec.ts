...
import { eventPriorityPath, eventPriorityTestCases } from "../Data/eventpriority6.data";
import { MisDashboardEdgesValidator } from "../Validator/mis-dashboard.edges.validator";
import { ApiValidationHelper } from "../../../core/helpers/api-validation.helper";

test.describe("Urgency level 6 events", () => {
  ...
  test(
    "Urgency level 6 events — consumer and DTR stay within all meters",
