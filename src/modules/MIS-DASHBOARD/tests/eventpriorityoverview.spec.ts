...
test.describe("Urgency today versus yesterday", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }) => {
      ...
      const allMeters = EventPriorityOverviewMapper.map(allResult.responseBody.data);
      const consumers = EventPriorityOverviewMapper.map(consumerResult.responseBody.data);
