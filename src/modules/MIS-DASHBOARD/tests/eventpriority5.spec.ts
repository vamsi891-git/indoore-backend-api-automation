...
import { eventPriorityPath, eventPriorityTestCases } from "../Data/eventpriority5.data";
import { MisDashboardEdgesValidator } from "../Validator/mis-dashboard.edges.validator";
import { ApiValidationHelper } from "../../../core/helpers/api-validation.helper";

test.describe("Urgency level 5 events", () => {
  ...
  test(
    "Urgency level 5 events — consumer and DTR stay within all meters",
