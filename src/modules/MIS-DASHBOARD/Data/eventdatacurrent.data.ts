export const eventCurrentQueries=[
...
export function isKnownSlowEventCurrentQuery(query: {
  reportType: string;
  period: string;
}): boolean {
  return (
    query.period === "monthly" ||
    (query.reportType === "category-wise" &&
      (query.period === "hourly" || query.period === "daily"))
  );
}
