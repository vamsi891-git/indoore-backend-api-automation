...
export class DtrSummaryValidator {
    ...
    validatePeriod(data: MappedDtrSummary,expected?: DtrSummaryPeriod,): void {
    ...
    validateLiveOk(mapped: MappedDtrSummary,expectedPeriod?: DtrSummaryPeriod,): void {
    ...
    validateLiveFleetContract(mapped: MappedDtrSummary,period: DtrSummaryPeriod,): void {
    ...
    validateScenario(mapped: MappedDtrSummary,scenario: DtrSummaryScenario,expectedPeriod?: DtrSummaryPeriod,): void {
        switch (scenario) {
