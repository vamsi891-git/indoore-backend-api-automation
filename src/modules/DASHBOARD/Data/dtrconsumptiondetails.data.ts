...
export const dtrConsumptionDetailsMaxResponseTimeMs = MASTER_DATA_MAX_RESPONSE_TIME_MS;

export const dtrConsumptionDetailsSuccessMessage = "DTR consumption details fetched successfully.";
...
export const DTR_CONSUMPTION_DETAILS_KIND_HEADERS: Record<DtrConsumptionDetailsKind, string> = {
  kwh: "kWh",
  kvah: "kVAh",
  kvarh: "kVARh",
};

export function columnKeysForKind(kind: DtrConsumptionDetailsKind): string[] {
  return [...DTR_CONSUMPTION_DETAILS_BASE_COLUMN_KEYS, kind, "logDate"];
}
...
function emptyContract(kind: DtrConsumptionDetailsKind): DtrConsumptionDetailsResponse {
  return {
    success: true,
    data: {
...
function withRowsContract(kind: DtrConsumptionDetailsKind): DtrConsumptionDetailsResponse {
  return {
    success: true,
    data: {
      columns: columnsForKind(kind),
...
export const dtrConsumptionDetailsContractKvahWithRows = withRowsContract("kvah");
export const dtrConsumptionDetailsContractKvarhWithRows = withRowsContract("kvarh");
