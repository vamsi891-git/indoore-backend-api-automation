...
export const dtrLoadUnbalanceDetailsMaxResponseTimeMs =
...
export const DTR_LOAD_UNBALANCE_DETAILS_METRIC_KEYS_ANY_OF = [
    "loadingUnbalance",
    "perUB",
] as const;

export const DTR_LOAD_UNBALANCE_DETAILS_PHASE_CURRENT_KEYS = [
    "ir",
    "iy",
] as const;
