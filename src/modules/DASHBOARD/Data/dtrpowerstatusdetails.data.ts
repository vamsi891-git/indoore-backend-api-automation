...
export const dtrPowerStatusDetailsMaxResponseTimeMs = MASTER_DATA_MAX_RESPONSE_TIME_MS;

export const dtrPowerStatusDetailsSuccessMessage = "DTR power status details fetched successfully.";
