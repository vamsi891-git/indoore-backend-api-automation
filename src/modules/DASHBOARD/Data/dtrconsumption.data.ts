...
const dtrConsumptionSuccessMessage = "DTR consumption data fetched successfully.";
...
export const dtrConsumptionContractNullHourlyResponse = nullPeriodContract("hourly", hourlyLabels);

/** Live sample from GET .../consumption?period=daily (10 Jul 2026) */
export const dtrConsumptionContractNullDailyResponse = nullPeriodContract("daily", dailyLabels);

/** Live sample from GET .../consumption?period=weekly (10 Jul 2026) */
export const dtrConsumptionContractNullWeeklyResponse = nullPeriodContract("weekly", weeklyLabels);
...
export const dtrConsumptionContractNullYearlyResponse = nullPeriodContract("yearly", yearlyLabels);
...
export function resolveDtrConsumptionQuery(scenario: DtrConsumptionScenario): DtrConsumptionQuery {
  switch (scenario) {
