...
const dtrSummarySuccessMessage = "DTR dashboard summary fetched successfully.";
...
function buildLiveFleetContract(period: DtrSummaryPeriod): DtrSummaryResponse {
...
export const dtrSummaryContractLiveHourlyResponse = buildLiveFleetContract("hourly");

/** Live sample from GET .../dtr/summary?period=daily (10 Jul 2026) */
export const dtrSummaryContractLiveDailyResponse = buildLiveFleetContract("daily");

/** Live sample from GET .../dtr/summary?period=weekly (10 Jul 2026) */
export const dtrSummaryContractLiveWeeklyResponse = buildLiveFleetContract("weekly");

/** Live sample from GET .../dtr/summary?period=monthly (10 Jul 2026) */
export const dtrSummaryContractLiveMonthlyResponse = buildLiveFleetContract("monthly");

/** Live sample from GET .../dtr/summary?period=yearly (10 Jul 2026) */
export const dtrSummaryContractLiveYearlyResponse = buildLiveFleetContract("yearly");
...
export function resolveDtrSummaryQuery(scenario: DtrSummaryScenario): DtrSummaryQuery {
  switch (scenario) {
