...
export const dtrPercentageLoadingDetailsMaxResponseTimeMs = MASTER_DATA_MAX_RESPONSE_TIME_MS;
      ...
      rows: [
        {
          ...
          dtr: "10IW1",
          msn: "19271515",
          loadingCondition: DTR_PERCENTAGE_LOADING_DETAILS_BAND_LABELS[band],
          loadingKva: 0,
          dtrRating: 100,
          loadPercent: 0,
          logDate: null,
...
export const dtrPercentageLoadingDetailsContractUnderUtilizedEmpty = emptyContract();
export const dtrPercentageLoadingDetailsContractCriticalWithRows = withRowsContract("critical");
export const dtrPercentageLoadingDetailsContractHighLoadWithRows = withRowsContract("high-load");
export const dtrPercentageLoadingDetailsContractNormalWithRows = withRowsContract("normal");
...
export const dtrPercentageLoadingDetailsTestCases: DtrPercentageLoadingDetailsTestCase[] = [
  ...
  },
  {
    ...
    tags: ["@dashboard", "@dtr-percentage-loading-details", "@edge"],
    nonEmptyExpected: false,
  },
  {
