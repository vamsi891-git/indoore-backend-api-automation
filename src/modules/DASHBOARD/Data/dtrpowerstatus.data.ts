...
const dtrPowerStatusSuccessMessage = "DTR power status chart fetched successfully.";
...
export const dtrPowerStatusContractNullHourlyResponse = nullPeriodContract("hourly", hourlyLabels);

/** Live sample from GET .../power-status?period=daily (10 Jul 2026) */
export const dtrPowerStatusContractNullDailyResponse = nullPeriodContract("daily", dailyLabels);

/** Live sample from GET .../power-status?period=weekly (10 Jul 2026) */
export const dtrPowerStatusContractNullWeeklyResponse = nullPeriodContract("weekly", weeklyLabels);
...
export const dtrPowerStatusContractLiveMonthlyResponse: DtrPowerStatusResponse = {
  ...
  data: {
    ...
    points: [
      ...
      ...["Jan 2026", "Feb 2026", "Mar 2026", "Apr 2026", "May 2026", "Jun 2026"].map((label) =>
        nullPoint(label),
      ),
      {
        label: "Jul 2026",
...
export function resolveDtrPowerStatusQuery(scenario: DtrPowerStatusScenario): DtrPowerStatusQuery {
  switch (scenario) {
