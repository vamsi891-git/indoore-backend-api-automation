...
export const dashboardMetricsSuccessMessage = "Dashboard data fetched successfully";
  ...
  data: {
    ...
    consumerType: {
      totalConsumers: {
        ...
        trends: [
          133059, 133099, 133140, 133154, 133154, 133173, 133173, 133194, 133201, 133223, 133223,
          133223, 133289, 133326, 133366, 133379, 133379, 133379, 133379, 133383, 133386, 133386,
          133388, 133388, 133388, 133388, 133388, 133388, 133395, 133137,
        ],
      },
      prepaid: {
        count: 329,
        ...
        trends: [
          10, 50, 91, 105, 105, 124, 124, 145, 152, 174, 174, 174, 224, 261, 301, 314, 314, 314,
          314, 318, 321, 321, 322, 322, 322, 322, 322, 322, 329, 329,
        ],
      ...
      postpaid: {
        ...
        trends: [
          133049, 133049, 133049, 133049, 133049, 133049, 133049, 133049, 133049, 133049, 133049,
          133049, 133065, 133065, 133065, 133065, 133065, 133065, 133065, 133065, 133065, 133065,
          133066, 133066, 133066, 133066, 133066, 133066, 133066, 132808,
        ],
    ...
    networkDetails: {
      ...
      dtrs: {
        ...
        trends: [
          4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797, 4797,
          4797, 4797, 4797, 4797, 4797, 4797, 4803, 5033, 5059,
        ],
      },
      consumers: {
        count: 133137,
        ...
        trends: [
          128900, 128900, 128902, 128903, 128910, 129296, 130040, 130428, 130805, 131252, 131769,
          131771, 132056, 132169, 132247, 132360, 132863, 133052, 133052, 133052, 133052, 133052,
          133379, 133137,
        ],
      },
    },
...
export const dashboardMetricsContractConnectionResponse: DashboardMetricsResponse = {
  ...
  data: {
    timestamp: "2026-08-13T05:21:27.437Z",
    connectionStatus: dashboardMetricsContractLiveFullResponse.data!.connectionStatus,
    categoryWiseConsumer: {},
    phaseWiseConsumer: {},
    oemWiseConsumer: {},
    consumerType: {},
  ...
  data: {
    ...
    consumerType: {
      totalConsumers: {
        ...
        percentage: "100.00",
        label: "Total Consumers",
        trends: trailingTrend(dashboardMetricsConsumerTrendLength, 133137),
      },
      prepaid: {
        count: 329,
        percentage: "0.25",
        label: "Prepaid Connections",
        trends: trailingTrend(dashboardMetricsConsumerTrendLength, 329),
        paymentContractTblRefId: 1,
      },
    },
    networkDetails: {},
  ...
  data: {
    ...
    networkDetails: {
      substations: {
        ...
        percentage: "0.42",
        label: "Substations",
        trends: trailingTrend(dashboardMetricsNetworkTrendLength, 26),
      },
      feeders: {
        count: 1161,
        percentage: "18.59",
        label: "Feeders",
        trends: trailingTrend(dashboardMetricsNetworkTrendLength, 1161),
      },
      dtrs: {
        count: 5059,
        percentage: "81.00",
        label: "Distribution Transformers (DTRs)",
        trends: trailingTrend(dashboardMetricsNetworkTrendLength, 5059),
      },
      consumers: {
        count: 133137,
        percentage: "100.00",
        label: "Active Consumers",
        trends: trailingTrend(dashboardMetricsNetworkTrendLength, 133137),
      },
    },
  },
  message: dashboardMetricsSuccessMessage,
