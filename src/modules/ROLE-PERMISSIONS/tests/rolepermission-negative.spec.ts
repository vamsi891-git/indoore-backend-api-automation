...
test.describe("Role Permission — Negative", () => {
  ...
  test("POST /permissions/roles — role name too short returns 400",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("POST /permissions/roles — duplicate role name returns 409 or 400",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("PATCH /permissions/roles/:id — empty body returns 400",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("PATCH /permissions/roles/:id — unknown role returns 404",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("PUT /permissions/roles/:id/permissions — unknown permission keys returns 400",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("DELETE /permissions/roles/:id — protected role returns 403",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("DELETE /permissions/roles/:id — unknown role returns 404",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
  ...
  test("PUT /roles/:roleId/modules/:moduleId — unknown role returns 404",
    { tag: ["@negative", "@permissions", "@role-permissions"] },
    async ({ authenticatedApi }) => {
      const assert = new AssertionEngine();
      const validation = new ValidationEngine();
