...
test.describe("HES Commands — Metering Mode (E2E)", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }, testInfo) => {
      ...
      const postUrl = `${process.env.BASE_URL}${METERING_MODE_PATH}`;
      ...
      if (
        ...
        validation.printSummary(
          ...
          postTime,
          {
            ...
            defectContext: {
              module: "HES-COMMANDS",
              endpoint: "/indore/commands/metering-mode",
              method: "POST",
              requestParams: body,
      ...
      ApiValidationHelper.finalize(validation, {
        ...
        defectContext: {
          module: "HES-COMMANDS",
          endpoint:
            "/indore/commands/metering-mode → /indore/commands/query-meter-job/:jobName",
          method: "POST → GET",
          requestParams: {
            body,
            jobName,
