...
test.describe("HES Commands — Profile Config (E2E)", () => {
  ...
  test(
    ...
    async ({ authenticatedApi }, testInfo) => {
      ...
      const postUrl = `${process.env.BASE_URL}${PROFILE_CONFIG_PATH}`;
      ...
      if (
        ...
        validation.printSummary(
          ...
          postTime,
          {
            ...
            defectContext: {
              module: "HES-COMMANDS",
              endpoint: "/indore/commands/profile-config",
              method: "POST",
              requestParams: body,
      ...
      ApiValidationHelper.finalize(validation, {
        ...
        defectContext: {
          module: "HES-COMMANDS",
          endpoint:
            "/indore/commands/profile-config → /indore/commands/query-meter-job/:jobName",
          method: "POST → GET",
          requestParams: {
            body,
            jobName,
