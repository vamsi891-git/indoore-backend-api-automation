...
test.describe("DTR Feeders API",() => {
        test("Validate DTR Feeders API",
            ...
            async ({authenticatedApi}) => {
                ...
                await PerformanceTracker.track(rawResponse,"DTR Feeders API",`${process.env.BASE_URL}/indore/dtr/${dtrFeedersData.dtrCode}/feeders`,responseTime);
                ...
                validation.execute("Status Validation",() =>
                        validator.validateStatuses(mapped.feeders,dtrFeedersData.allowedStatuses)
                );
                ...
                validation.execute("Last Communication Validation",() =>
                        validator.validateLastCommunication(mapped.feeders)
                );
                validation.execute("Null Last Communication Validation",() =>
                        validator.validateNullLastCommunication( mapped.feeders)
                );
                validation.execute("Unique ID Validation",() =>
                        validator.validateUniqueIds(mapped.feeders)
                );

                validation.execute("Empty Array Validation",() =>
                        validator.validateEmptyArray( mapped.feeders)
                );
                ...
                validation.execute("Response Data Type Validation",() =>
                        validator.validateResponseDataType(mapped.feeders)
                );
                // =====================================
                // SUMMARY
                // =====================================
